        ...
        mDatabaseRef.child("Users").child("UsersImage").child("dqrtlBrUk1bOdxNGjCQ1VPjgTR23").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if(upload.getCategory().equals("CA")) {
                        mUploads.add(upload);
                    }

                }

                mAdapter = new ImageAdapter(CAActivity.this, mUploads);
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(CAActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
